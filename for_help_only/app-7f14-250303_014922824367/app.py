...
CORS(app, resources={r"/api/*": {"origins": [
    "http://calcdynamics-frontend.eba-hdaedjtx.us-east-1.elasticbeanstalk.com", 
    "http://localhost:3000",
    "http://www.calcdynamics.com",
    "https://www.calcdynamics.com",
    "http://calcdynamics.com",
    "https://calcdynamics.com",
    "http://calcdynamics-api.eba-zku5kvfn.us-east-1.elasticbeanstalk.com",
...
# Function to generate individual plots for specific time steps
...
# Function to generate a single plot for one time step
